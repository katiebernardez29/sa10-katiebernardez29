...
controller.on(['hello', 'hi', 'howdy'], ['direct_mention', 'direct_message'], (bot, message) => {
...
controller.on('help', ['direct_mention'], (bot, message) => {
...
controller.on('hungry', ['direct_mention', 'direct_message'], (bot, message) => {
